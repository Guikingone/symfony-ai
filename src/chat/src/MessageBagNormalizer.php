...
final class MessageBagNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array
    {
        return [
            ...
            'forkedFrom' => $data->getForkedFrom()?->toRfc4122() ?? null,
            'chat' => $data->getChat(),
            'messages' => array_map(
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): MessageBag
    {
        ...
        /** @var MessageBag|ForkAwareTrait|ChatAwareTrait $messageBag */
        $messageBag = new MessageBag(...$messages);
        $messageBag->setForkedFrom(null !== $data['forkedFrom'] ? Uuid::fromRfc4122($data['forkedFrom']) : null);
