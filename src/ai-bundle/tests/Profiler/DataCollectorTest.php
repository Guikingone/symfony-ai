...
final class DataCollectorTest extends TestCase
{
    ...
    {
        $clock = new MockClock('2020-01-01 10:00:00');
        $state = new WorkflowState(Uuid::v7()->toRfc4122(), currentPlace: 'foo');

        $workflow = $this->createMock(WorkflowInterface::class);

        $traceableAgentWorkflow = new TraceableAgentWorkflow(new AgentWorkflow($workflow, [], new WorkflowStateStore()), $clock);
