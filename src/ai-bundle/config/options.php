                    ...
                    ->children()
                        ...
                        ->arrayNode('speech')
                            ...
                            ->children()
                                ->booleanNode('enabled')->defaultTrue()->end()
                                ->stringNode('platform')
                                    ->info('Service name of the speech platform (e.g. ai.platform.elevenlabs)')
                                    ->defaultNull()
                                ->end()
                            ...
                            ->end()
                            ->validate()
                                ->ifTrue(static fn (array $v): bool => ($v['enabled'] ?? false) && null === ($v['platform'] ?? null))
                                ->thenInvalid('The "platform" must be configured when speech is enabled.')
                            ->end()
                            ->validate()
